...
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL || "TCGMarketPortugal <onboarding@resend.dev>";
...
async function sendVerificationEmail(to, token) {
    ...
    await resend.emails.send({
        from: FROM_EMAIL,
        to,
        subject: "Confirma o teu email — TCGMarketPortugal",
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto;">
                <h2>Bem-vindo ao TCGMarketPortugal!</h2>
                ...
                <p style="color:#888; font-size:13px;">Se não criaste uma conta no TCGMarketPortugal, podes ignorar este email.</p>
            </div>
        `,
    });
}
...
async function sendPasswordResetEmail(to, token) {
    ...
    await resend.emails.send({
        from: FROM_EMAIL,
        to,
        subject: "Repor password — TCGMarketPortugal",
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto;">
