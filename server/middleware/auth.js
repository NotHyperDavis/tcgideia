...
router.post("/register", async (req, res) => {
    ...
    if (!terms_accepted) {
        return res.status(400).json({ error: "Tens de aceitar os Termos de Uso e a Política de Privacidade para criares conta." });
    }
    ...
    try {
        ...
        const result = await pool.query(
            `INSERT INTO users (name, email, password_hash, verification_token, terms_accepted_at)
             VALUES ($1, $2, $3, $4, NOW())
